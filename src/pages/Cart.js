...
function Cart() {
   ...
   const onClearCart = () => {
      if (window.confirm("Ви справді хочете очистити корзину?")) {
         dispatch(clearCart());
      }
   };

   const onRemoveItem = (id) => {
      if (window.confirm("Ви справді хочете видалити піццу?")) {
   ...
   const onClickOrder = () => alert("Ваше замовлення пройшло успішно!");
         ...
         <div className="container container--cart">
            {totalCount ? (
               ...
               <div className="cart cart--empty">
                  ...
                  <p>
                     Схоже, ви ще не заказували піццу.
                     <br />
                     Для того, щоб заказати піццу, перейдіть на головну
                     сторінку.
                  </p>
